...
- [x] Ejecutar `docker run hello-world` sin errores
- [x] Correr un contenedor interactivo (`docker run -it ubuntu bash`)
- [x] Ver contenedores con `docker ps` y `docker ps -a`
- [x] Ejecutar Python en un contenedor
- [x] Montar un directorio local con `-v`
- [x] Usar diferentes versiones de Python (tags)
- [x] Detener y eliminar contenedores

---

_Computación II - 2026 - Clase 1_
