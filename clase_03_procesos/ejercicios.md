...
- [x] Ejecuta comandos en paralelo (no secuencialmente)
- [x] Muestra PID al iniciar cada comando
- [x] Muestra cuando termina cada comando
- [x] Reporta código de salida de cada comando
- [x] Muestra tiempo total (debe ser menor que la suma de tiempos individuales)
- [x] Maneja correctamente comandos que fallan

---

_Computación II - 2026 - Clase 3_
